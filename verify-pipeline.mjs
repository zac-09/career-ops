...
import { loadStates, resolveStatus } from './states-helper.mjs';
...
// Canonical statuses + aliases come from templates/states.yml (source of truth).
...
for (const e of entries) {
  if (!resolveStatus(e.status, aliasToLabel)) {
